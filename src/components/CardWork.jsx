...
const CardWork = () => {
    const listPorto = [
        ...
        },
        {
            ...
            stack: `✦︎ Built with React and Vite for fast and scalable development<br/>✦︎ Designed responsive layouts using Tailwind CSS<br/>✦︎ Enhanced user experience with smooth animations using Framer Motion<br/>✦︎ Used Lanis for smooth scrolling`,
